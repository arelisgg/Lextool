                            ...
                            echo ' 
                                    <div class="item" style="padding: 5px">
                                        <div class="card" style="width: 100%">
                                            ...
                                            <div class="card-body">
                                                <video class="card-img-top" controls="" style="width:250px;height:160px;"> 
                            ...
                            echo ' 
                                    <div class="item" style="padding: 5px">
                                        <div class="card" style="width: 100%">
                                            ...
                                            <div class="card-body">
                                                <audio class="card-img-top" controls="" style="width:250px;height:40px; margin: 30px 0px 20px 0px">
                            ...
                            echo ' 
                                    <div class="item" style="padding: 5px">
                                        <div class="card" style="width: 100%">
                                            ...
                                            <div class="card-body">
                                                <img class="card-img-top" src="../../../backend/web/uploads/project/illustration_lemma/'.$illustration->url.'" alt="'.$illustration->url.'" style="width: 250px;height:160px;">
                                            </div>
                                        </div>  
                                    </div>
                                    ';
