...
/* @var $searchModel backend\models\DocMakePlanSearch */
/* @var $model backend\models\Project */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Plan de confección de documentos';
$this->params['breadcrumbs'][] = $this->title;
?>
<div id="id_project" class="hidden"><?=$model->id_project?></div>
<div id="name_project" class="hidden"><?=$model->name?></div>
<div class="doc-make-plan-index">

    <?php
    Modal::begin([
        'header' => '<h4 id=22 class="modelo"></h4>',
        'id' => 'modal',
        //'size' => 'modal-lg',
        'options' => [
            'tabindex' => false
    ...
    Pjax::begin([
        'id' => 'doc-make-plan-pjax',
        //'timeout' => 10000,
    ]);
    ?>

    <?= GridView::widget([
        'id' => 'doc-make-plan-grid',
                ...
                'buttons' => [
                    ...
                    'view' => function ($url,$model,$key) {
                        return Html::a('<span class="glyphicon glyphicon-eye-open"></span>',
                            '', [
                                "onclick"=>"actionView('$model->id_doc_make_plan', '".Url::to(['/doc_make_plan/view',])."')",
                                "title"=>"Ver"]);
                    },
        ...
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'doc-make-plan-pjax']],
        'responsive'=>true,
        'panel' => [
        ...
        'toolbar'=>[
            ...
            ['content'=>
                Html::a('<span class="glyphicon glyphicon-plus"></span>', '', [
                    "onclick"=>"actionCreate('$model->id_project','".Url::to(['/doc_make_plan/create',])."')",
                ...
                $.ajax({
                    ...
                    success:function(data){
                        if (data == "Error"){
                            ...
                            krajeeDialogSuccess.alert('La tarea de confección ha sido eliminada.');
                        }
                    },
                    fail: function(){
                        krajeeDialogError.alert("No se ha podido eliminadar, ha ocurrido un error.");
