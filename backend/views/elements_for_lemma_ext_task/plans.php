...
$this->title = 'Planes de redacción de artículos lexicográficos';
            ...
            <div class="row">
                ...
                <div class="item" style="padding: 25px 20px">
                  <div class="card" style="width: 100%">
                    ...
                    <p><strong>Componentes lexicográficos:</strong> ' . $plan->getSubmodelName() . '</p>
                    ...
                    <a class="btn btn-danger" href="' . Url::to(['art_red_task/index', 'id_redaction_plan' => $plan->id_redaction_plan]) . '">Continuar <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>  
                </div>
                ';
                ...
                <div class="item" style="padding: 25px 20px">
                   ...
                   <p><strong>Componentes Lexicográficos:</strong> ' . $plan->getSubmodelName() . '</p>
                    ...
                    <p style="color: #00a65a;"><strong>Estado:</strong> En Tiempo </p>
                     <p><strong>Fecha inicio: </strong>' . $plan->start_date . '</p>
                    <p> <strong>Fecha fin: </strong> ' . $plan->end_date . '</p>
                    <a class="btn btn-success" href="' .  Url::to(['art_red_task/index', 'id_redaction_plan' => $plan->id_redaction_plan])  . '">Continuar <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>          
                </div>
                ';
