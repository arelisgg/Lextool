...
<div class="lemma-form">
    <div class="row">
        <div class="col-md-12">
            ...
            <?php $lemaString = "Lema";?>
            <h1><?=$lemaString?></h1><h1>Holalalalalala</h1>
            <?= $form->field($model, 'subestructure')->hiddenInput(['value' => $lemaString])->label(false) ?>
            ...
            <input id="img_url" type="hidden" name="img_url" value="<?= $source->url ?>">
            ...
            <div id="pdf-main-container">
                ...
                <div id="pdf-contents">
                    <div id="pdf-meta">
                        ...
                        <div id="page-count-container">Página <!--<div id="pdf-current-page"></div>--> <input id="pdf-current-page" type="number" value="1" title="Page" style="width: 40px; text-align: right;" size="3" min="1" > de <div id="pdf-total-pages"></div></div>
                    </div>
