...
$this->title = 'Planes de extracción de documentos complementarios';
...
<div class="plans">
    ...
    <div id="app" class="lemma-index">
        ...
        <section id="demos">
            ...
            <div class="card-body">
                ...
                <a class="btn btn-danger" href="' . Url::to(['document_ext_task/index', 'id_ext_plan' => $plan->id_doc_ext_plan]) . '">Continuar <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
                </div>
                ';
    ...
    <div class="card-body">
        ...
        <p><strong>Fecha Inicio: </strong>' . $plan->start_date . '</p>
        <p> <strong>Fecha Fin: </strong> ' . $plan->end_date . '</p>
        <a class="btn btn-success" href="' . Url::to(['document_ext_task/index', 'id_ext_plan' => $plan->id_doc_ext_plan]) . '">Continuar <i class="fa fa-arrow-circle-right"></i></a>
    </div>
</div>
                </div>
                ';
