...
<div id="revision_plan" class="hidden"><?= $plan->id_revision_plan?></div>
                                        ...
                                        <div class="box box-solid box-shadow">
                                            ...
                                            <div class="box-body">
                                                <ul id="elements" class="submodel-container">
                                                    <li
                                                            :id="elem.id_element"
                                                            :class="{ selected: elem.selected, lemma: elem.type === 'Lema'}"
                                            ...
                                            <div class="box-body">
                                                <div class="article">
                                                    ...
                                                    <form id="save-article" @submit.prevent="saveLexArticle" method="post" action="save-lex-article">
                                                        ...
                                                        <input type="hidden" name="id_revision_plan" :value="id_revision_plan">
                                                        ...
                                                        <div class="checkbox margin-top-10">
                                                            <label for="reviewed">
                                                                <input id="reviewed" type="checkbox" :value="lex_article.reviewed" v-model="lex_article.reviewed" name="reviewed"> {{ reviewed_text }}
                                                            </label>
                                                        </div>
