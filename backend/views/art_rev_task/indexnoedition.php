...
$this->title = 'Revisión sin derecho de edición de lemas';
...
<div class="revition-index">
    ...
    <?= GridView::widget([
        ...
        'toolbar'=>[
            ...
            '{toggleData}',
            ['content'=>
                Html::a('<i class="glyphicon glyphicon-repeat"></i>', 'indexnoedition?id_revision_plan='.$revision_plan->id_revision_plan, [ 'class'=>'btn btn-default', 'title'=>'Reiniciar']),
