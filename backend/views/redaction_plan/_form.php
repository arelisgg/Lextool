...
<div class="redaction-plan-form">

    <?php $form = ActiveForm::begin([
        'id' => 'redaction-plan-form',
    ]); ?>
...
<script>
    $('form#redaction-plan-form').on('beforeSubmit', function(e)
    {
        var form = $(this);
        $.post(
            form.attr("action"),
            ...
            if (result == "Error"){
                ...
                krajeeDialogSuccess.alert('La tarea de redacción ha sido '+result+'.');
            }
        }).fail(function() {
