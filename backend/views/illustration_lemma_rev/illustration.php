...
<source src="'.$illustration->getIllustrationUrl().'" type="video/'.$extension[1].'">
</video>';

} elseif ($extension[1] == "mp3"){

    echo '<audio class="kv-preview-data file-preview-audio" controls="" style="width: 870px;height:40px;">
<source src="'.$illustration->getIllustrationUrl().'" type="audio/'.$extension[1].'">
</audio>';

} elseif ($extension[1] == "jpg" || $extension[1] == "jpeg" || $extension[1] == "png" || $extension[1] == "gif"){

    echo '<img src="'.$illustration->getIllustrationUrl().'" style="width: 870px;height:430px;">';
}
