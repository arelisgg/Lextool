...
/* @var $searchModel backend\models\DocRevPlanSearch */
/* @var $model backend\models\Project */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Plan de revisón de documentos';
$this->params['breadcrumbs'][] = $this->title;
?>
<div id="id_project" class="hidden"><?=$model->id_project?></div>
<div id="name_project" class="hidden"><?=$model->name?></div>
<div class="doc-rev-plan-index">

    <?php
    Modal::begin([
        'header' => '<h3 id=9 class="modelo"></h3>',
        'id' => 'modal',
        //'size' => 'modal-lg',
        'options' => [
            'tabindex' => false
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'attribute'=>'doc_ext_plan',
                'value' =>  'extDocPlan.ext_plan_name',
            ],
            'start_date',
            'end_date',
            [
                ...
                'buttons' => [
                    ...
                    'view' => function ($url,$model,$key) {
                        return Html::a('<span class="glyphicon glyphicon-eye-open"></span>',
                            '', [
                                "onclick"=>"actionView('$model->id_rev_plan', '".Url::to(['/doc_rev_plan/view',])."')",
                                "title"=>"Ver"]);
                    },
        ...
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'doc-rev-plan-pjax']],
        'responsive'=>true,
        'panel' => [
        ...
        'toolbar'=>[
            ...
            ['content'=>
                Html::a('<span class="glyphicon glyphicon-plus"></span>', '', [
                    "onclick"=>"actionCreate('$model->id_project','".Url::to(['/doc_rev_plan/create',])."')",
