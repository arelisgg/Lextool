...
/* @var $searchModel backend\models\LemmaRevPlanSearch */
/* @var $model backend\models\Project */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Plan de revisón de lemas';
$this->params['breadcrumbs'][] = $this->title;
?>
<div id="id_project" class="hidden"><?=$model->id_project?></div>
<div id="name_project" class="hidden"><?=$model->name?></div>
<div id="lemma-rev-plan-index" class="lemma-rev-plan-index">

    <?php
    Modal::begin([
        'header' => '<h3 id=7 class="modelo"></h3>',
        'id' => 'modal',
        //'size' => 'modal-lg',
        'options' => [
            'tabindex' => false
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'attribute'=>'lemma_ext_plan',
                'value' =>  'extPlan.ext_plan_name',
                ...
                'buttons' => [
                    ...
                    'view' => function ($url,$model,$key) {
                        return Html::a('<span class="glyphicon glyphicon-eye-open"></span>',
                            '', [
                                "onclick"=>"actionView('$model->id_rev_plan', '".Url::to(['/lemma_rev_plan/view',])."')",
                                "title"=>"Ver"]);
                    },
        ...
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'lemma-rev-plan-pjax']],
        'responsive'=>true,
        'panel' => [
        ...
        'toolbar'=>[
            ...
            ['content'=>
                Html::a('<span class="glyphicon glyphicon-plus"></span>', '', [
                    "onclick"=>"actionCreate('$model->id_project','".Url::to(['/lemma_rev_plan/create',])."')",
