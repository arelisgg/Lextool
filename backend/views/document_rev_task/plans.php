...
$this->title = 'Planes de revisión de documentos complementarios';
    ...
    <div id="app" class="lemma-index">
        ...
        <section id="demos">
                ...
                <div class="large-12 columns">
                    <div class="owl-carousel owl-theme">
                        ...
                        foreach ($plans as $plan) {
                            if (count($plan->extDocPlan->documents) > 0){
            ...
            <div class="card-body">
                ...
                <h3>' . $plan->extDocPlan->docType->name . '</h3>
                ...
                <a class="btn btn-danger" href="' . Url::to(['document_rev_task/index', 'id_rev_plan' => $plan->id_rev_plan]) . '">Continuar <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
                </div>
                ';
            ...
            <div class="card-body">
                    ...
                    <p><strong>Fecha Inicio: </strong>' . $plan->start_date . '</p>
                    <p> <strong>Fecha Fin: </strong> ' . $plan->end_date . '</p>
                    <a class="btn btn-success" href="' . Url::to(['document_rev_task/index', 'id_rev_plan' => $plan->id_rev_plan]) . '">Continuar <i class="fa fa-arrow-circle-right"></i></a>
              </div>
              </div>
                </div>
                ';
