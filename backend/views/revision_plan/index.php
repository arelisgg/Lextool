...
/* @var $searchModel backend\models\RevisionPlanSearch */
/* @var $model backend\models\Project */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Plan de revisión';
$this->params['breadcrumbs'][] = $this->title;
?>
<div id="id_project" class="hidden"><?=$model->id_project?></div>
<div id="name_project" class="hidden"><?=$model->name?></div>
<div class="revision-plan-index">

    <?php
    Modal::begin([
        'header' => '<h3 id=17 class="modelo"></h3>',
        'id' => 'modal',
        //'size' => 'modal-lg',
        'options' => [
            'tabindex' => false
    ...
    Pjax::begin([
        'id' => 'revision-plan-pjax',
        //'timeout' => 10000,
    ]);
    ?>

    <?= GridView::widget([
        'id' => 'revision-plan-grid',
                ...
                'buttons' => [
                    ...
                    'view' => function ($url,$model,$key) {
                        return Html::a('<span class="glyphicon glyphicon-eye-open"></span>',
                            '', [
                                "onclick"=>"actionView('$model->id_revision_plan', '".Url::to(['/revision_plan/view',])."')",
                                "title"=>"Ver"]);
                    },
        ...
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'revision-plan-pjax']],
        'responsive'=>true,
        'panel' => [
        ...
        'toolbar'=>[
            ...
            ['content'=>
                Html::a('<span class="glyphicon glyphicon-plus"></span>', '', [
                    "onclick"=>"actionCreate('$model->id_project','".Url::to(['/revision_plan/create',])."')",
