...
/**
 * LemmaExtPlanSearch represents the model behind the search form of `app\models\LemmaExtPlan`.
 */
class LemmaExtPlanSearch extends LemmaExtPlan
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id_lemma_ext_plan', 'id_project', 'id_user'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $query->distinct('id_lemma_ext_plan');
...
//            'defaultOrder' => ['usuario'=>SORT_ASC]
        ...
        $query->andFilterWhere([
            'id_lemma_ext_plan' => $this->id_lemma_ext_plan,
