...
class Illustration_documentController extends Controller
{
    ...
    public function actionIndex($id_illustration_plan)
    {
        ...
        if(User::userCanIllustrationDoc($illustration_plan->id_project)){
    ...
    public function actionIllustration($id){
        ...
        if(User::userCanIllustrationDoc($illustration->id_project)){
    ...
    public function actionView($id)
    {
        ...
        if(User::userCanIllustrationDoc($model->document->id_project)){
